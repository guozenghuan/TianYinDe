...
public class HttpXmlClient {
	...
	/**
	 * 获取微信的四个参数，appId，nonceStr，signature，timeStamp
	 * @return
	 */
	public static Map<String, Object> getWxFourPareme() {
		// 获取access_token
		Map<String, String> params = new HashMap<String, String>();
		params.put("corpid", ConfigUtil.getAppID());
		params.put("corpsecret", ConfigUtil.getAppSecret());
	...
	public static void main(String[] args) {
		String access_token = get("https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid="+ConfigUtil.getAppID()+"&secret="+ConfigUtil.getAppSecret());
		System.out.println(getWxFourPareme());
	}
