...
public class SysUserServiceImpl implements SysUserService {
	...
	@Override
	public List<String> queryByUserIdForOpenidList(String nickName,String userId,String ordersSn) {
		List<SysUserEntity> list = sysUserDao.queryByUserIdList();
		...
		for(SysUserEntity userEntity : list){
			if(userEntity != null && !StringUtils.isEmpty(userEntity.getEmail())){
				TcUserEntity tcUserEntity = tcUserDao.queryObject(Long.valueOf(userEntity.getEmail()));
				if(tcUserEntity != null && !StringUtils.isEmpty(tcUserEntity.getOpenid())){
					data.add(tcUserEntity.getOpenid());
				}
			}
		}
		return data;
