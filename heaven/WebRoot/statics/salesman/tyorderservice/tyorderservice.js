$(function () {
    $("#jqGrid").jqGrid({
        url: '../../../salesman/user/tyorderservice_list',
        datatype: "json",
        colModel: [			
			...
			{ label: '操作',  name: 'id',width: 2, formatter: function(value, options, row){
				...
				if(row.status == 1){//服务结束
					...
					return '<a title="编辑订单信息" class="btn btn-primary" style="padding: 6px 6px;margin-left: 6px;margin-top: 3px;" href="tyorderservice_add.html?id='+row.id+'"><i class="fa fa-pencil-square-o" style="font-size: 18px;width: 30px;"></i></a>'+xianxiaMoneyBtn+okServiceBtn;
				}	
			}}
        ],
		viewrecords: true,
